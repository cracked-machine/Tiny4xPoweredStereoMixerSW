...
TEST(Dac7718_Gain6Packet, IncrementTo0xFFFWrap)
{
    GenericIncrementTo0xFFFWrap(
        ...
        DAC7718::Types::ShiftRegisterBytes{ 0x9e, 0xFF, 0xF0 },
        DAC7718::Types::ShiftRegisterBits{ 0b100111101111111111110000 }
    );
}
...
TEST(Dac7718_Gain6Packet, DecrementToZeroWrap)
{
    GenericDecrementToZeroWrap(
        ...
        DAC7718::Types::ShiftRegisterBytes{ 0x9e, 0x00, 0x00 },
        DAC7718::Types::ShiftRegisterBits{ 0b100111100000000000000000 }
    );
}
