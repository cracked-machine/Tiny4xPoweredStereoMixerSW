 ...
 * 
 */
TEST(Dac7718OffsetAPacket, IncrementTo0xFFFWrap)
{
 ...
 * 
 */
TEST(Dac7718OffsetAPacket, DecrementToZeroWrap)
{
 ...
 * 
 */
TEST(Dac7718OffsetAPacket, Increment3dbFrom0)
{
 ...
 * 
 */
TEST(Dac7718OffsetAPacket, Increment3dbFrom1)
{
 ...
 * 
 */
TEST(Dac7718OffsetAPacket, Decrement3dbFrom0x800)
{
 ...
 * 
 */
TEST(Dac7718OffsetAPacket, Decrement3dbFrom0xFFF)
{
